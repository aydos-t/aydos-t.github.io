...
<header class="header">
    ...
    <div class="header-2">
        <div class="flex">
            ...
            <nav class="navbar">
                <a href="home.php">Главный</a>
                <a href="shop.php">Все книги</a>
            ...
            <div class="icons">
                ...
                <?php
                $select_cart_number = mysqli_query(
                    $conn,
                    "SELECT * FROM 
                ...
                ?>
                <a href="cart.php"> <i class="fas fa-shopping-cart"></i> <span>(<?php
                        echo $cart_rows_number; ?>)</span> </a>
            </div>
