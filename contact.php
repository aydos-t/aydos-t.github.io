...
<div class="heading">
    <h3 class="contact-hed">СВЯЗАТЬСЯ С НАМИ</h3>
    <!-- <p><a href="home.php">Главный</a> / контакт </p> -->
</div>
...
<section class="contact">
    ...
    <form action="" method="post">
        ...
        <input type="text" name="name" required placeholder="Имя" class="box">
        <input type="email" name="email" required placeholder="Эл.Почта" class="box">
        <input type="number" name="number" required placeholder="Телефон" class="box">
        <textarea name="message" class="box" placeholder="Напишите сообщения" cols="30" rows="10"></textarea>
