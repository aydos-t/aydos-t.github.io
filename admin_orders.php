...
<section class="orders">
    ...
    <h1 class="title">РАЗМЕЩЕННЫЕ ЗАКАЗ</h1>
    ...
    <div class="box-container">
        ...
        if (mysqli_num_rows($select_orders) > 0) {
            while ($fetch_orders = mysqli_fetch_assoc($select_orders)) {
                ?>
                <div class="box">
                    <p> ИДН пользователя : <span><?php echo $fetch_orders['user_id']; ?></span></p>
                    ...
                    <p>Всего книг : <span><?php echo $fetch_orders['total_products']; ?></span></p>
                    <p>Итоговая цена : <span>$<?php echo $fetch_orders['total_price']; ?>/-</span></p>
                    <p>Cпособ оплаты : <span><?php echo $fetch_orders['method']; ?></span></p>
            ...
            echo '<p class="empty">Заказ еще не сделан!</p>';
        }
        ?>
    </div>
</section>
