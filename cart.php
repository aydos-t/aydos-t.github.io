...
if (isset($_POST['update_cart'])) {
    ...
    or die('query failed');
    $message[] = 'Количество корзин обновлено!';
}
...
<div class="heading">
    <h3>КОРЗИНА</h3>
    <!-- <p><a href="home.php">Главный</a> / корзинка </p> -->
</div>
...
<section class="shopping-cart">
    ...
    <div class="box-container">
        ...
        if (mysqli_num_rows($select_cart) > 0) {
            while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
                ?>
                <div class="box">
                    <a href="cart.php?delete=<?php
                        echo $fetch_cart['id']; ?>" class="fas fa-times">
                    </a>
                    ...
                    <div class="sub-total"> Промежуточный итог : <br/> <span>$<?php
                        echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?> /- </span>
                    </div>
                </div>
                <?php
    ...
    <div style="margin-top: 2rem; text-align:center;">
        ...
        <a href="cart.php?delete_all" class="delete-btn <?php
            ...
            ?>" onclick="return confirm('Удалить все книги из корзины?');">Удалить все
        </a>
    </div>

    <div class="cart-total">
        <p>Общая сумма : <span>$<?php
            echo $grand_total; ?>/- </span>
        </p>
        <div class="flex">
